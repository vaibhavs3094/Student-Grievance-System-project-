...
if( isset($_POST['roll_no']) && isset($_POST['password']))
           {
                ...
                if (isset($_POST['login'])) //to insert data in a table 
				{
               ...
               
                    {
                    		...
                    		$query = "SELECT `roll_no`, `password` FROM `login` WHERE `roll_no` = '$roll_no' AND `password` = SHA('$password')";
			...
			<div class="resp-tabs-container">
					...
					<div class="facts">
						...
						<div class="register">
							<form action ="file:///C:/Users/Administrator/Desktop/horizontal-responsive-form-ui/index.html" method ="post">
								...
								<p>First Name </p>
								<input type="text" class="text" value="" name="first_name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" >
								<p>Last Name </p>
								<input type="text" class="text" value="" name="last_name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" >
								<p>Email Address </p>
								<input type="text" class="text" value="" name="email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" >
								<p>Password </p>
								<input type="password" value="" onfocus="this.value = '';" name="password" onblur="if (this.value == '') {this.value = '';}">
								
								<div class="sign-up">
									<input type="reset" value="Reset">
									<input type="submit"   value="Sign In" >
									<a href  ="new_complaintform"></a>
									<div class="clear"> </div>
								</div>
							</form>
			 ...
			 <div class="tab-2 resp-tab-content" aria-labelledby="tab_item-1">
					 	<div class="facts">
							...
							<form>
								<input type="text" class="text" value="Username" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Username';}" ><a href="#" class=" icon email"></a>
