...
if($user_level==1)
{
	...
	echo"<a href='http://185.27.134.22/roundcubemail/'><p>Complaint check </p></a>";
	echo"<a href='http://localhost/phpmyadmin/sql.php?db=admin_panel&table=users&sql_query=SELECT+%2A+FROM+%60users%60&message_to_show=The+row+has+been+deleted&goto=tbl_sql.php&token=0f85e484ad5b964bd4651e51528a99b7&message=1+row+deleted.
	+%28Query+took+0.0684+sec%29#PMAURL-1:index.php?db=&table=&server=1&targe
	t=&token=0f85e484ad5b964bd4651e51528a99b7'><p>Compaints</p></a>";

} 
else if($user_level==2)
{
   echo"<a href='http://185.27.134.22/roundcubemail/'><p>Panel</p></a>";
}
