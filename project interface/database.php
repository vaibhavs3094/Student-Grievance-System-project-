		...
		<div class="container">
			<form action="">
				...
				<div class="form-group has-success has-feedback">
					<label for="element-5" class="control-label">This is the text of the label 2</label>
			...
			<form action="" class="form-inline">
				<div class="form-group">
					<label for="element-3" class="sr-only">This is the text of the label</label>
					<input type="text" id="element-3" class="form-control input-lg" placeholder="Enter email">
				</div>
				<div class="form-group">
					<label for="element-4" class="sr-only">This is the text of the label 2</label>
